...
class MessagesController extends Controller
{
  ...
  public function index()
  {
      ...
      return view('contact/home')->with('messages', $messages);
  }
  ...
  public function create(int $id = 0, String $subject = '')
   {
      ...
      return view('contact/create')->with(['users' => $users, 'subject' => $subject]);
  }
  ...
  public function send(Request $request) {
      ...
      return redirect()->to('contact/home')->with('status', 'Message sent successfully!');
  }

  public function sent() {
      $messages = Message::with('userTo')->where('user_id_from', Auth::id())->orderBy('created_at', 'desc')->get();

      return view('contact/sent')->with('messages', $messages);
  }
  ...
  public function read(int $id) {
      ...
      return view('contact/read')->with('message', $message);
  }
  ...
  public function delete(int $id) {
      ...
      return redirect()->to('contact/home')->with('status', 'Message deleted successfully!');
  }

  public function deleted() {
      $messages = Message::with('userFrom')->where('user_id_to', Auth::id())->deleted()->get();

      return view('contact/deleted')->with('messages', $messages);
  }
  ...
  public function return(int $id) {
      ...
      return redirect()->to('contact/home');
  }
}
